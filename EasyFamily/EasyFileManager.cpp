...
int EasyFileManager::moveFile(const std::string& fullPath, const std::string& tarFolder) {
  std::string m;
  return moveFile(fullPath, tarFolder, m);
}

int EasyFileManager::moveFile(const std::string& fullPath, const std::string& tarFolder, std::string& newPath) {
...
std::string EasyFileManager::findFilepathWithPattern(const std::string& dirPath, const std::string& pattern) {
...
std::vector<std::string> EasyFileManager::findFilesWithPattern(const std::string& dirPath, const std::string& pattern) {
...
std::pair<std::string, std::string> EasyFileManager::splitPathAndFilename(const std::string& fullPath) {
